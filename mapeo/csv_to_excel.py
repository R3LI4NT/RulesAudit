...
def mapear_csv_a_excel(ruta_csv, carpeta_destino):
    ...
    print(f"[+] Codificación utilizada: {encoding_usado}")
...
def mapear_lote_a_excel(carpeta_csv, carpeta_destino):
    ...
    for ruta in rutas_csv:
        ...
        if df is not None:
            ...
            print(f"[!] Error leyendo {os.path.basename(ruta)}")
    ...
    print(f"[+] Archivos procesados exitosamente: {archivos_procesados} de {len(rutas_csv)}")
    return True
